...
extern void ChangeActiveIconboxIconText (Widget icon, XPointer dummy,
...
extern void HandleIconBoxButtonMotion (Widget icon, XPointer client_data,
				       XEvent *pev);
extern void HandleIconBoxIconKeyPress (Widget icon, XPointer dummy,
				       XKeyEvent *keyEvent);
#ifndef MOTIF_ONE_DOT_ONE
extern void IconScrollVisibleCallback (Widget w, XPointer client_data,
				  XmAnyCallbackStruct *call_data);
#endif
extern void IconActivateCallback (Widget w, XPointer client_data,
				  XmAnyCallbackStruct *call_data);
